...
<a class="dropdown-item" href="./../index2">Logout</a>
</div>
</li>
</ul>
</div>
...
<li>
<a href="#"><img src="../assets/img/sidebar/icon-8.png" alt="icon"> <span>archivage</span></a>
</li>
<li>
...
<div class="row">
<div class="col-md-6">
<h3 class="page-title mb-0">archive</h3>
</div>
<div class="col-md-6">
...
<div class="form">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <input type="text" name="name" placeholder="Importer votre document (.pdf)">
