...
try {
    ...
    $stmt_id1 = $pdo_enote->prepare('SELECT u.nom, u.prenom, u.email, u.img , p.specialite
    FROM profes p
    JOIN utilisateurs u ON p.id_ut = u.id_ut
    WHERE p.id_d = (SELECT chef_d.id_d FROM chef_d WHERE chef_d.id_ut = (SELECT id_ut FROM utilisateurs WHERE utilisateurs.email = :email AND utilisateurs.mdp = :password))');
...
<li >
<a href="#"><img src="assets/img/sidebar/icon-4.png" alt="icon"> <span> Profs departement</span></a>
</li>
<li >
...
<div class="row">
<div class="col-md-6">
<h3 class="page-title mb-0">profes de departement</h3>
</div>
<div class="col-md-6">
        ...
        <tbody>
            ...
            if (!empty($results)) {
                foreach ($results as $row) {
                    echo "<tr>";
                    echo '<td><img src="../les_images/' . $row['img'] . '" width="30" alt="prof"></td>';
                    echo "<td>" . $row['nom'] . "</td>";
