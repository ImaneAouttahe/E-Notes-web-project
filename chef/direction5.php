...
if ($niveau_id && $module_id) {
    ...
    if (count($pourcentages) == 2) { // On suppose qu'il y a un pourcentage pour DS et un pourcentage pour Examen
        ...
        // Sélectionner les informations sur les étudiants et leurs notes de DS et d'examen
        $stmt_etudiants_notes = $pdo->prepare('SELECT u.nom, u.prenom, 
                                                SUM(CASE WHEN n.type_epreuve = "DS" THEN n.note END) AS note_ds,
                                                SUM(CASE WHEN n.type_epreuve = "Examen" THEN n.note END) AS note_exam
                                            FROM utilisateurs u
                                            JOIN etudiants et ON u.id_ut = et.id_ut
                                            LEFT JOIN notes n ON et.id_et = n.id_et
                                            WHERE et.id_n = :niveau_id AND n.id_m = :module_id
                                            GROUP BY et.id_et');
        ...
        echo "Erreur: les pourcentages des épreuves pour ce module ne sont pas disponibles.";
    }
} else {
...
<div class="row">
<div class="col-md-6">
<h3 class="page-title mb-0">consulter notes : moyenne</h3>
</div>
<div class="col-md-6">
