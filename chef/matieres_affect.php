...
// Sélectionnez les modules affectés à ce professeur
// Sélectionnez les modules affectés à ce professeur avec les noms de filière, de niveau et de semestre
$stmt_affectations_prof = $pdo->prepare('SELECT m.id_mod, m.nom_mod, f.nom_f, n.nom_n, s.nom
                                        FROM modules m
                                        INNER JOIN filieres f ON m.id_fil = f.id_f
                                        INNER JOIN niveau n ON m.id_n = n.id_n
                                        INNER JOIN semestre s ON n.id_s = s.id_s
                                        WHERE m.id_prof = :prof_id');
$stmt_affectations_prof->execute(['prof_id' => $prof_id]);
$affectations_prof = $stmt_affectations_prof->fetchAll(PDO::FETCH_ASSOC);
...
<li>
<a href="#"><img src="assets/img/sidebar/icon-10.png" alt="icon"> <span>p.Matières affectées</span></a>
</li>
<li>
...
<div class="row">
<div class="col-md-6">
<h3 class="page-title mb-0">matieres affectees</h3>
</div>
<div class="col-md-6">
...
<div>
<?php if (!empty($affectations_prof)): ?>
    <table class="custom-table">
        ...
        <tbody>
            <?php foreach ($affectations_prof as $module): ?>
                <tr>
...
<?php else: ?>
    <p>Aucun module n'a été affecté à ce professeur.</p>
<?php endif; ?>
</div>
