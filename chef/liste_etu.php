...
// Sélectionnez les filières affectées à ce professeur
$stmt_filieres = $pdo->prepare('SELECT DISTINCT f.id_f, f.nom_f
                                FROM modules m
                                JOIN filieres f ON m.id_fil = f.id_f
                                WHERE m.id_prof = :prof_id');
$stmt_filieres->execute(['prof_id' => $prof_id]);
...
<li>
<a href="#"><img src="assets/img/sidebar/icon-4.png" alt="icon"> <span>p.Listes Etudiants</span></a>
</li>
<li>
...
<div class="form-container">
    <h2>Choisir une Filière pour Voir la Liste des Étudiants</h2>
    <form method="post" action="direction1.php">
