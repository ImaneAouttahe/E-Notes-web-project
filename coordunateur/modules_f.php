...
try {
    ...
    $stmt_id = $pdo_enote->prepare('SELECT utilisateurs.id_ut, cordonnateur.id_c, filieres.id_f,
                                        filieres.nom_f, modules.nom_mod ,niveau.nom_n , semestre.nom
                                    FROM utilisateurs 
                                    ...
                                    INNER JOIN niveau ON modules.id_n = niveau.id_n
                                    INNER JOIN semestre ON niveau.id_s = semestre.id_s
...
<li>
<a href="#"><img src="assets/img/sidebar/icon-5.png" alt="icon"> <span>modules filiere</span></a>
</li>
<li>
...
<div class="row">
<div class="col-md-6">
<h3 class="page-title mb-0">modules filiere</h3>
</div>
<div class="col-md-6">
