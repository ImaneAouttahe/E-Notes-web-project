...
$stmt_id = $pdo_enote->prepare('SELECT utilisateurs.id_ut, utilisateurs.nom, utilisateurs.prenom, utilisateurs.email ,utilisateurs.img ,filieres.nom_f,niveau.nom_n 
                                       FROM utilisateurs
                                       INNER JOIN etudiants ON utilisateurs.id_ut = etudiants.id_ut
                                       INNER JOIN filieres ON etudiants.id_f = filieres.id_f
                                       INNER JOIN niveau ON etudiants.id_n = niveau.id_n
                                       WHERE etudiants.id_f = :filiere_id');
...
<li >
<a href="#"><img src="assets/img/sidebar/icon-4.png" alt="icon"> <span> Etudiants filiere</span></a>
</li>
<li>
    ...
    <table class="custom-table">
        ...
        <tbody>
            ...
            if ($result) {
                do {
                    echo "<tr>";
                    echo '<td><img src="../les_images/' . $result['img'] . '" width="30" alt="etudiant"></td>';
                    echo "<td>" . $result['nom'] . "</td>"; // Affiche le nom du module
                    echo "<td>" . $result['prenom'] . "</td>"; // Affiche le nom de la filière
                    echo "<td>" . $result['nom_f'] . "</td>";
                    echo "<td>" . $result['nom_n'] . "</td>";
                    echo "</tr>";
