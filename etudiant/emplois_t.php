...
// Récupérer l'utilisateur connecté et son id_n
try {
    $stmt_user = $pdo->prepare('SELECT u.id_ut, u.nom, u.prenom, u.email, u.ville, u.img, u.role, e.id_n 
                                FROM utilisateurs u 
    ...
    $user_id = $user['id_ut'];
    $id_n = $user['id_n']; // Récupération de l'id_n de l'utilisateur connecté

    // Récupérer les informations des fichiers PDF associés à ce niveau d'études
    $stmt_pdf = $pdo->prepare('SELECT idd, id_n, nom_fichier, contenu_pdf, date_creation 
                               FROM fichiers_pdf_2 
                               WHERE id_n = :id_n');
    $stmt_pdf->execute(['id_n' => $id_n]);
    $fichiers = $stmt_pdf->fetchAll(PDO::FETCH_ASSOC);
...
<span class="user-img"><img class="rounded-circle" src="<?= $img ?>" width="30" alt="etu"></span>
...
<li>
<a href="#"><img src="../assetss/img/sidebar/icon-5.png" alt="icon"> <span>Emplois de temps</span></a>
</li>
<li>
<a href="notes_modules.php"><img src="../assetss/img/sidebar/icon-7.png" alt="icon"> <span>Notes</span></a>
</li>
...
<div class="row">
<div class="col-md-6">
<h3 class="page-title mb-0">Emplois de temps</h3>
</div>
<div class="col-md-6">
