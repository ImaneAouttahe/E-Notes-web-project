...
try {
    $sql_img = $pdo->prepare('SELECT u.nom , u.prenom , u.email , u.ville ,u.img , u.role , niveau.nom_n  FROM utilisateurs u  JOIN etudiants ON etudiants.id_ut = u.id_ut JOIN niveau ON etudiants.id_n = niveau.id_n WHERE email = :email AND mdp = :password');
    $sql_img->execute(array('email' => $email, 'password' => $password));
        ...
        <div class="tab-content pt-2">
            ...
            <div class="tab-pane fade show active profile-overview" id="profile-overview">
              ...
              <div class="row">
                ...
                <div class="col-lg-9 col-md-8"><?php echo $admin['nom_n']; ?></div>
              </div>
