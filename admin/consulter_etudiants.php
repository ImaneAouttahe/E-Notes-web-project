...
<ul class="list-unstyled" style="display: none;">
<li><a href="#"><span>consulter Etudiants</span></a></li>
...
<form  method="post" action="direction2.php" enctype="multipart/form-data">
<div class="form-horizontal center-block col-md-12" >
