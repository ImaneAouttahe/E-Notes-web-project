...
try {
    // Requête pour récupérer les informations des chefs de départements avec le nom du département
    $sql_chefs_departements = $pdo->query('SELECT u.nom, u.prenom, u.email, u.mdp, u.role, u.ville, u.img, d.nom_d
                                           FROM utilisateurs u
                                           JOIN chef_d cd ON u.id_ut = cd.id_ut
                                           JOIN departements d ON cd.id_d = d.id_d');
    $chefs_departements = $sql_chefs_departements->fetchAll(PDO::FETCH_ASSOC);
} catch (PDOException $e) {
    echo "Erreur lors de la récupération des chefs de départements : " . $e->getMessage();
    exit();
}
?>
...
<li><a href="#"><span>consulter </span></a></li>
...
<ul class="list-unstyled" style="display: none;">
<li><a href="#"><span>consulter Chefs</span></a></li>
...
<div class="row">
<div class="col-md-6">
<h3 class="page-title mb-0">consulter chefs</h3>
</div>
<div class="col-md-6">
...
<li class="breadcrumb-item"><span>Dashboard</span></li>
    ...
    <table class="table table-hover">
        ...
        <tbody>
        <?php foreach ($chefs_departements as $chef_departement): ?>
                <tr>
                    <td><?= $chef_departement['nom'] ?></td>
                    <td><?= $chef_departement['prenom'] ?></td>
                    <td><?= $chef_departement['email'] ?></td>
                    <td><?= $chef_departement['mdp'] ?></td>
                    <td><?= $chef_departement['role'] ?></td>
                    <td><?= $chef_departement['ville'] ?></td>
                    <td><?= $chef_departement['nom_d'] ?></td>
                    <td><img src="../les_images/<?= $chef_departement['img'] ?>" alt="Image du chef de département" width="50"></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
