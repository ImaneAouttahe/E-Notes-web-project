...
// Requête pour sélectionner tous les professeurs, chefs de département et coordinateurs
$stmt = $pdo->prepare('SELECT u.nom, u.prenom, u.ville, p.specialite , u.email, d.nom_d, u.img 
                      FROM utilisateurs u 
                      JOIN profes p ON u.id_ut = p.id_ut 
                      JOIN departements d ON p.id_d = d.id_d 
                      WHERE u.role IN ("professeur", "chef_departement", "cordonnateur")');
$stmt->execute();
...
<div class="row">
<div class="col-md-6">
<h3 class="page-title mb-0">consulter professeurs</h3>
</div>
<div class="col-md-6">
    ...
    <table class="table table-hover">
        ...
        <?php foreach ($professeurs as $professeur): ?>
            <tr>
                ...
                <td><?php echo $professeur['ville']; ?></td>
                <td><?php echo $professeur['email']; ?></td>
                <td><?php echo $professeur['nom_d']; ?></td>
                <td><img src="../les_images/<?php echo $professeur['img']; ?>" alt="Image Professeur" width="50"></td>
            </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
