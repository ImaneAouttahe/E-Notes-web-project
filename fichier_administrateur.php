...
<a class="dropdown-item" href="./admin/profile.php">mon Profile</a>
...
<li class="active">
<a href="fichier_administrateur.php"><img src="assetss/img/sidebar/icon-1.png" alt="icon"><span>Dashboard</span></a>
</li>
<li class="submenu">
<a href="#"><img src="assetss/img/sidebar/icon-4.png" alt="icon"> <span> Professeurs</span> <span class="menu-arrow"></span></a>
<ul class="list-unstyled" style="display: none;">
<li><a href="./admin/consulter_profes.php"><span>consulter </span></a></li>
<li><a href="./admin/ajouter_prof.php"><span>ajouter Professeur</span></a></li>
<li><a href="#"><span>modifier Professeur</span></a></li>
</ul>
</li>
<li class="submenu">
<a href="#"><img src="assetss/img/sidebar/icon-4.png" alt="icon"> <span> Etudiants</span> <span class="menu-arrow"></span></a>
<ul class="list-unstyled" style="display: none;">
<li><a href="./admin/consulter_etudiants.php"><span>consulter Etudiants</span></a></li>
<li><a href="./admin/ajouter_etud.php"><span>ajouter Etudiant</span></a></li>
<li><a href="#"><span>modifier Etudiant</span></a></li>
</ul>
</li>
<li class="submenu">
<a href="#"><img src="assetss/img/sidebar/icon-4.png" alt="icon"> <span> coordinateurs</span> <span class="menu-arrow"></span></a>
<ul class="list-unstyled" style="display: none;">
<li><a href="./admin/consulter_coor.php"><span>consulter </span></a></li>
<li><a href="./admin/affecter_coor.php"><span>affecter </span></a></li>
<li><a href="#"><span>modifier </span></a></li>
</ul>
</li>
<li class="submenu">
<a href="#"><img src="assetss/img/sidebar/icon-4.png" alt="icon"> <span> Chefs</span> <span class="menu-arrow"></span></a>
<ul class="list-unstyled" style="display: none;">
<li><a href="./admin/consulter_chefs.php"><span>consulter Chefs</span></a></li>
<li><a href="./admin/affecter_chef.php"><span>affecter Chef</span></a></li>
<li><a href="#"><span>modifier Chef</span></a></li>
</ul>
</li>
<li class="submenu">
<a href="#"><img src="assetss/img/sidebar/icon-20.png" alt="icon"> <span> filieres</span> <span class="menu-arrow"></span></a>
<ul class="list-unstyled" style="display: none;">
<li><a href="./admin/creerfiliere.php"><span>creer filiere</span></a></li>
<li><a href="./admin/consulter_f.php"><span>consulter filieres</span></a></li>
</ul>
</li>
