...
<a class="dropdown-item" href="./chef/profile.php">mon Profile</a>
...
<li class="active">
<a href="fichier_chefsdepartements.php"><img src="assetss/img/sidebar/icon-1.png" alt="icon"><span>Dashboard</span></a>
</li>
<li >
<a href="./chef/profes_d.php"><img src="assetss/img/sidebar/icon-4.png" alt="icon"> <span> Profs departement</span></a>
</li>
<li >
<a href="./chef/etud_dep.php"><img src="assetss/img/sidebar/icon-4.png" alt="icon"> <span> filieres dep</span></a>
</li>
<li>
<a href="./chef/modules_d.php"><img src="assetss/img/sidebar/icon-5.png" alt="icon"> <span>Modules dep</span></a>
</li>
<li>
<a href="./chef/consulter_emploi.php"><img src="assetss/img/sidebar/icon-18.png" alt="icon"> <span>Emplois de temps</span></a>
</li>
<li>
<a href="./chef/affect_mod.php"><img src="assetss/img/sidebar/icon-14.png" alt="icon"> <span>Affectation modules</span></a>
</li>
<li>
<a href="./chef/arch/archivage.php"><img src="assetss/img/sidebar/icon-8.png" alt="icon"> <span>archivage</span></a>
</li>
<li>
<a href="./chef/matieres_affect.php"><img src="assetss/img/sidebar/icon-10.png" alt="icon"> <span>p.Matières affectées</span></a>
</li>
<li>
<a href="./chef/liste_etu.php"><img src="assetss/img/sidebar/icon-4.png" alt="icon"> <span>p.Listes Etudiants</span></a>
</li>
<li>
<a href="./chef/inserer_notes.php"><img src="assetss/img/sidebar/icon-12.png" alt="icon"> <span>p.Insertion des Notes</span></a>
</li>
<li>
<a href="#"><img src="assetss/img/sidebar/icon-26.png" alt="icon"> <span>p.Consulter Notes</span> <span class="menu-arrow"></span></a>
<ul class="list-unstyled" style="display: none;">
<li><a href="./chef/notes_ds.php"><span>Notes DS</span></a></li>
<li><a href="./chef/notes_examen.php"><span>Notes Examen</span></a></li>
<li><a href="./chef/moyenne.php"><span>Moyenne</span></a></li>
</ul>
</li>
<li>
<a href="./chef/modifier.php"><img src="assetss/img/sidebar/icon-7.png" alt="icon"> <span>p.Modifier Notes</span></a>
</li>
