...
<li>
<a href="#"><img src="assets/img/sidebar/icon-12.png" alt="icon"> <span>p.Insertion des Notes</span></span></a>
<li>
<li>
...
<div class="form-container container-fluid">
    <form method="post" action="direction2.php" id="studentForm">
        <div class="row">
            <div class="col-md-12">
                <h3> Niveau : </h3>
            ...
            <div class="col-md-12">
                ...
                <select name="type_epreuve" id="type_epreuve" class="form-control">
                    <option value="">Choisir un Type d'épreuve</option>
            ...
            <div class="col-md-12">
                <h3> Pourcentage :</h3>
                <input type="number" name="pourcentage" id="pourcentage" class="form-control" placeholder="Pourcentage">
                <br>
            </div>
            <div class="col-md-4">
