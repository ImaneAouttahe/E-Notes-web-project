...
<li>
<a href="inserer_notes.php"><img src="assets/img/sidebar/icon-12.png" alt="icon"> <span>p.Insertion des Notes</span></span></a>
<li>
<li>
...
<li>
<a href="#"><img src="assets/img/sidebar/icon-7.png" alt="icon"> <span>p.Modifier Notes</span></a>
</li>
...
<div class="form-container container-fluid">
    <form method="post" action="direction6.php" id="studentForm">
        <div class="row">
            <div class="col-md-12">
                <h3> Niveau : </h3>
            ...
            <div class="col-md-12">
                ...
                <select name="type_epreuve" id="type_epreuve" class="form-control">
                    <option value="">Choisir le Type d'épreuve</option>
