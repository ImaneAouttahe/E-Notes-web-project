...
<div class="main-wrapper">
                <div class="content container-fluid">
                    <div class="row">
                        ...
                        <div class="alert alert-info" role="alert" id="el2">
                            Pourcentage de DS: <?= $etudiants[0]['pourcentage'] ?>%
                        </div>
                            <div class="card">
                                <div class="card-body">
